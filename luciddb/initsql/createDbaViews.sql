...
grant execute on specific function convert_nullable_int_to_boolean to dba;
...
grant select on dba_schemas to dba;
...
grant select on dba_tables to dba;
...
grant select on dba_columns to dba;
...
grant select on dba_column_stats to dba;
...
grant select on dba_column_histograms to dba;
...
grant select on dba_views to dba;
...
grant select on dba_stored_tables to dba;
...
create or replace view dba_unclustered_indexes as
    select
        ...
        i.modification_timestamp as last_modified_timestamp,
        i.table_name,
        i.is_unique,
        i.remarks,
        i.mof_id,
    ...
    where
        ...
        and index_name not like 'SYS$DELETION_INDEX%'
;

grant select on dba_unclustered_indexes to dba;
...
grant select on dba_routines to dba;
...
grant select on dba_functions to dba;
...
grant select on dba_routine_parameters to dba;
...
grant select on dba_function_parameters to dba;
...
grant select on dba_foreign_wrappers to dba;
...
grant select on dba_foreign_wrapper_options to dba;
...
grant select on dba_foreign_servers to dba;
...
grant select on dba_foreign_server_options to dba;
...
grant select on dba_foreign_tables to dba;
...
grant select on dba_foreign_table_options to dba;
...
grant select on dba_system_parameters to dba;
...
grant select on dba_sessions to dba;
...
grant select on dba_system_info to dba;
...
grant select on dba_labels to dba;
...
grant select on dba_system_backups to dba;
...
create or replace view dba_auth_ids as
  select
    ...
    cast("modificationTimestamp" as timestamp) as last_modified_timestamp,
    cast("mofId" as varchar(128)) as mof_id,
    cast("lineageId" as varchar(128)) as lineage_id
  from sys_fem."Security"."AuthId";

grant select on dba_auth_ids to dba;
...
grant select on dba_users to dba;
...
create or replace view dba_roles as
  select
    ...
    cast("lineageId" as varchar(128)) as lineage_id
  from 
    sys_fem."Security"."Role";

grant select on dba_roles to dba;
...
grant select on dba_element_grants to dba;

create or replace view dba_inherited_roles as
  select
    inheritor.name as inheritor_name,
    roles.name as inherited_role_name,
    g."withGrantOption" as with_grant_option,
    cast(g."Grantee" as varchar(128)) as inheritor_mof_id,
    cast(g."Element" as varchar(128)) as inherited_role_mof_id
  from
    sys_fem."Security"."Grant" as g
  inner join
    sys_root.dba_auth_ids as inheritor
  on
    inheritor.mof_id = g."Grantee"
  inner join
...
grant select on dba_inherited_roles to dba;

create or replace view dba_jars as
  select
    cast(j."name" as varchar(128)) as name,
    cast(j."url" as varchar(128)) as url,
    case
      when j."deploymentState" = 0 then 'NOT_DEPLOYED'
      when j."deploymentState" = 1 then 'DEPLOYMENT_PENDING'
      when j."deploymentState" = 2 then 'DEPLOYED'
      when j."deploymentState" = 3 then 'DEPLOYED_PARTIAL'
      when j."deploymentState" = 4 then 'UNDEPLOYMENT_PENDING'
    end as deployment_state,
    svi.object_catalog as catalog_name,
    svi.object_schema as schema_name,
    cast(j."description" as varchar(65535)) as remarks,
    cast(j."creationTimestamp" as timestamp) as creation_timestamp,
    cast(j."modificationTimestamp" as timestamp) as last_modified_timestamp,
    cast(j."mofId" as varchar(128)) as mof_id,
    cast(j."lineageId" as varchar(128)) as lineage_id
  from sys_fem."SQL2003"."Jar" j
  inner join sys_boot.jdbc_metadata.schemas_view_internal svi
  ON svi."mofId" = j."namespace";

grant select on dba_jars to dba;
...
grant execute on specific procedure flush_code_cache to dba;
...
grant execute on specific procedure kill_session to dba;
...
external name 'class net.sf.farrago.syslib.FarragoKillUDR.killSession';
grant execute on specific procedure kill_session_cancel to dba;
...
grant execute on specific procedure kill_statement to dba;
...
external name 'class net.sf.farrago.syslib.FarragoKillUDR.killStatement';
grant execute on specific procedure kill_statement_cancel to dba;
...
grant execute on specific procedure kill_all_matching_statements to dba;
...
external name 'class net.sf.farrago.syslib.FarragoKillUDR.killStatementMatch';
grant execute on specific procedure kill_all_matching_statements_cancel to dba;
...
grant execute on specific function retrieve_repository_lob_text to dba;
...
grant execute on specific procedure export_catalog_xmi to dba;
...
grant execute on specific procedure export_schema_to_file to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportSchemaToFile';
grant execute on specific procedure export_schema_to_file_2 to dba;
...
grant execute on specific procedure export_schema_with_options to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportSchemaToCsv';
grant execute on specific procedure export_schema_standard to dba;
...
grant execute on specific procedure export_foreign_schema_with_options to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportForeignSchemaToCsv';
grant execute on specific procedure export_foreign_schema_standard to dba;
...
grant execute on specific procedure export_schema_incremental_with_options
to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportSchemaIncrementalToCsv';
grant execute on specific procedure export_schema_incremental_standard to dba;
...
grant execute on specific procedure export_foreign_schema_incremental_with_options to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportForeignSchemaIncrementalToCsv';
grant execute on specific procedure export_foreign_schema_incremental_standard to dba;
...
grant execute on specific procedure export_merged_schema_with_options to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportMergedSchemas';
grant execute on specific procedure export_merged_schema_standard to dba;
...
grant execute on specific procedure export_query_to_file to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportQueryToFile';
grant execute on specific procedure export_query_to_file_2 to dba;
...
called on null input
external name 'class net.sf.farrago.syslib.FarragoExportSchemaUDR.exportQueryToFile';
grant execute on specific procedure export_query_to_file_3 to dba;
...
grant execute on specific procedure test_data_server to dba;
...
grant execute on specific procedure test_all_servers_for_wrapper to dba;
...
grant execute on specific procedure backup_database to dba;
...
grant execute on specific procedure backup_database_if_space_available to dba;
...
grant execute on specific procedure restore_database to dba;
...
grant execute on specific procedure restore_database_without_catalog to dba;
...
grant execute on specific procedure change_default_character_set_to_unicode to dba;
...
grant execute on specific procedure shutdown_database to dba;
...
grant execute on specific function get_current_sessionid to public;
...
grant execute on specific function generate_ddl_for_schema to dba;
...
external name
'class net.sf.farrago.syslib.FarragoDdlViewUDR.generateForSchema';
grant execute on specific function generate_ddl_for_schema2 to dba;
...
grant execute on specific function generate_ddl_for_catalog to dba;
...
external name
'class net.sf.farrago.syslib.FarragoDdlViewUDR.generateForCatalog';
grant execute on specific function generate_ddl_for_catalog2 to dba;
...
grant execute on specific function generate_ddl_for_table to dba;
...
external name
'class net.sf.farrago.syslib.FarragoDdlViewUDR.generateForTable';
grant execute on specific function generate_ddl_for_table2 to dba;
...
grant execute on specific function generate_ddl_for_routine to dba;
...
external name
'class net.sf.farrago.syslib.FarragoDdlViewUDR.generateForRoutine';
grant execute on specific function generate_ddl_for_routine2 to dba;
...
grant execute on specific function generate_ddl_for_specific_routine to dba;
...
external name
'class net.sf.farrago.syslib.FarragoDdlViewUDR.generateForSpecificRoutine';
grant execute on specific function generate_ddl_for_specific_routine2 to dba;
...
grant execute on specific function generate_ddl_for_jar to dba;
...
external name
'class net.sf.farrago.syslib.FarragoDdlViewUDR.generateForJar';
grant execute on specific function generate_ddl_for_jar2 to dba;
...
grant execute on specific function generate_ddl_for_server to dba;
...
grant execute on specific function generate_ddl_for_wrapper to dba;
...
grant execute on specific function generate_ddl_for_index to dba;
...
external name
'class net.sf.farrago.syslib.FarragoDdlViewUDR.generateForIndex';
grant execute on specific function generate_ddl_for_index2 to dba;
...
grant execute on specific function generate_ddl_for_user to dba;
...
grant execute on specific function generate_ddl_for_role to dba;
...
grant execute on specific function generate_ddl_for_label to dba;
