...
explain plan excluding attributes for select lname,dname
from emp,dept
where emp.deptno=dept.deptno and dept.dname='Marketing';

explain plan excluding attributes for select lname,dname from emp,dept
...
-- of select list
explain plan excluding attributes for select 1 from emp,dept
where emp.deptno=dept.deptno and dept.deptno=20
order by 1;

explain plan excluding attributes for select emp.fname from emp,dept
where emp.deptno=dept.deptno and dept.deptno<20
order by 1;
