...
call applib.do_for_entire_schema('select * from %TABLE_NAME%', 'TESTSCHEMA');
...
call applib.do_for_entire_schema('grant select on %TABLE_NAME% to MONDRIAN_USER', 'TESTSCHEMA');
