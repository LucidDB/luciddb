...
SELECT n1, POWER(n1, 5) FROM TEST_INTEGER_TABLE ORDER BY 1;
SELECT n2, POWER(n2, 5) FROM TEST_INTEGER_TABLE ORDER BY 1;
SELECT n3, POWER(n3, 5) FROM TEST_INTEGER_TABLE ORDER BY 1;
SELECT n4, POWER(n4, 5) FROM TEST_INTEGER_TABLE ORDER BY 1;
SELECT n5, POWER(n5, 5) FROM TEST_INTEGER_TABLE ORDER BY 1;
SELECT n1, POWER(n1, 5) FROM TEST_NUMERIC_TABLE ORDER BY 1;
SELECT n2, POWER(n2, 5) FROM TEST_NUMERIC_TABLE ORDER BY 1;
SELECT n3, POWER(n3, 5) FROM TEST_NUMERIC_TABLE ORDER BY 1;
SELECT n4, POWER(n4, 5) FROM TEST_NUMERIC_TABLE ORDER BY 1;
SELECT n5, POWER(n5, 5) FROM TEST_NUMERIC_TABLE ORDER BY 1;
SELECT n1, POWER(n1, 5) FROM TEST_REAL_TABLE ORDER BY 1;
SELECT n2, POWER(n2, 5) FROM TEST_REAL_TABLE ORDER BY 1;
SELECT n3, POWER(n3, 5) FROM TEST_REAL_TABLE ORDER BY 1;
SELECT n4, POWER(n4, 5) FROM TEST_REAL_TABLE ORDER BY 1;
SELECT n5, POWER(n5, 5) FROM TEST_REAL_TABLE ORDER BY 1;
