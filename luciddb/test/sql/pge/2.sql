...
SELECT AL3.SRVPLN_KEY, AL3.SRVPLN_ID,
 ...
 AL4.REVN_YR_MO, 
--  MAX(AL5.USG_DAYS_NUM),
--  MAX(AL5.RSD_SVC_BILG_AMT), MAX(AL5.USGC_BILL_KW_VAL),
--  MAX(AL5.USG_BILL_KWH), MAX(AL5.RSD_DMND_CHRG_AMT),
--  MAX(AL5.RSD_CUST_CHRG_AMT), MAX(AL5.RSD_CCOGC_AMT),
--  MAX(AL5.RSD_CCOGA_AMT), MAX(AL5.RSD_TOP_SRCHRG_AMT),
--  MAX(AL5.RSD_BALG_CHRG_AMT), MAX(AL5.RSD_ST_SLSTX_AMT),
--  MAX(AL5.RSD_TRSPT_CHRG_AMT)
 AVG(AL5.USG_DAYS_NUM),
