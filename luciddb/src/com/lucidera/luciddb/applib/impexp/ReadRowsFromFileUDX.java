...
/**
 * Implements <a href="http://pub.eigenbase.org/wiki/LucidDbAppLib_READ_ROWS_FROM_FILE">READ_ROWS_FROM_FILE</a>
 * @author Ray Zhang 
 * @version $Id$
 */ 
public class ReadRowsFromFileUDX {
	...
	public static InputStream openFile(String url) throws Exception {
	...
	public static void execute(ResultSet inputSet, String url,
		...
		while (true) {
			...
			try {
				...
				throw new Exception("Error: " +e.getMessage() + "\n"+ counter+" rows are inserted successfully."); 
			}
