 ...
 * //BB/bb713/server/SQL/cleanPhone.java
 */
public class CleanPhoneUdf
{
    ...
    /**
     * Convert a character to a digit. Note that this may only be valid for
     * English phones, where an English character corresponds to a number.
     *
     ...
     */
    protected static char digitConvert(char in)
        throws ApplibException
    {
        ...
        case 'z':
            return '9';
        default:
            throw ApplibResource.instance().CleanPhoneDigitUnmappable.ex();
        }
    }
    ...
    /**
     * Convert a phone number to the default parenthetical format, i.e., (999)
     * 999-9999
     *
    ...
    /**
     * Convert a phone number to one of two known formats: (999) 999-9999 and
     * 999-999-9999
     *
     * @param in phone number to cleanse
    ...
    /**
     * Convert a phone number to one of two known formats, throwing an exception
     * if the format is not possible and rejection is request. Valid format
     * types map to (999) 999-9999 and 999-999-9999
     *
     * @param in phone number to cleanse
     * @param format_type format to convert to
        ...
        throws ApplibException
    {
        ...
        try {
            ...
            throw ApplibResource.instance().InvalidPhoneOutputFmt.ex();
        }
    ...
    /**
     * Convert a phone number to an arbitrary format, throwing an exception if
     * the format is not possible and an exception is requested. Valid format
     * types contain 9's to correspond to a digit, and any other characters
     * returned as part of the new string.
     *
     * @param in phone number to cleanse
