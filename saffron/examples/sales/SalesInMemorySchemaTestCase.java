...
{
    static final SalesInMemoryConnection connection =
        new SalesInMemoryConnection();

    public SalesInMemorySchemaTestCase(String s)
        throws Exception
    {
        super(s);
        arguments =
            new OJStatement.Argument [] {
                new OJStatement.Argument("salesDb", connection)
            };
    }
