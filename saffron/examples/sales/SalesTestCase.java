...
public abstract class SalesTestCase extends SaffronTestCase
{
    ...
    public void _testAnonymousIterator()
    {
        ...
        Util.discard(j);
        Object o =
            runQuery("select twos "
                + "from (int[]) new java.util.Iterator() { " + "		 int i; "
    ...
    {
        Object o =
            runQuery("select " + "from salesDb.emps as emp "
        ...
        assertSynthetic(
            o,
            12,
            new String [] { "emp", "dept", "dept2" });
    }

    public void _testExists()
    {
        Object o =
            runQuery("select dept from salesDb.depts as dept where exists ("
    ...
    public void _testNested()
    {
        // column is relation
        Object o =
            runQuery("select {" + " dept.deptno as deptno, "
                + " (select from salesDb.emps as emp "
    ...
    {
        Util.discard(
            runQuery("select emp.empno from salesDb.emps as emp " + "union "
    ...
    {
        Object o =
            runQuery("select " + "from salesDb.depts as dept "
    ...
    public void testCorrelatedExistsMissingFrom()
    {
        ...
        Object o =
            runQuery("select i from new int[] {0,3,1,2} as i "
    ...
    {
        Object o =
            runQuery("select " + "from (select from salesDb.depts as d "
    ...
    public void testCorrelatedReferToVariables2LevelsOut()
    {
        ...
        Object o =
            runQuery("select from salesDb.emps as emp where emp.deptno in ("
    ...
    public void testEmptySelectInFromQueryFails()
    {
        ...
        // FAILS
        Throwable throwable =
            runQueryCatch("select t.emps from (select from salesDb.emps) as t");
    ...
    {
        Object o =
            runQuery("select emp from salesDb.emps as emp "
                + "where emp.deptno in ("
                + " select dept.deptno from salesDb.depts as dept "
    ...
    public void testIterable()
    {
        ...
        Object o =
            runQuery(
                ...
                new OJStatement.Argument [] {
                    new OJStatement.Argument("iterable", Iterable.class,
                        iterable)
                });
    ...
    public void testJoinEmptySelect()
    {
        ...
        Object o =
            runQuery("select from salesDb.emps join salesDb.depts "
                + " on emps.deptno == depts.deptno");
        assertSynthetic(
            o,
            3,
            new String [] { "emps", "depts" });
    }

    public void testJoinWhere()
    {
        Object o =
            runQuery("select from new int[] {1,2} as i" + nl
    ...
    {
        Object o =
            runQuery("select {emp, dept} from salesDb.emps as emp "
                + "join salesDb.depts as dept "
    ...
    public void testOutputAsIterable()
    {
        ...
        assertEquals(
            4,
            toList(((Iterable) o).iterator()).size());
    }
    ...
    public void testReferenceEnclosingSelectItemFails()
    {
        ...
        Throwable throwable =
            runQueryCatch("select {1 as one, 2 as two} where exists ("
                + " select where one > 0)");
    ...
    {
        Object o =
            runQuery("select 1 from salesDb.emps as emp where emp.deptno > 30");
        assertTrue(o instanceof int []);
        int [] a = (int []) o;
    ...
    public void testUnboxedSelectOnJoinFromQuery()
    {
        ...
        // SUCCEEDS
        Object o =
            runQuery("select t.emps from (" + " select from salesDb.emps"
