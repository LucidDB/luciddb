 ...
 * {@link net.sf.saffron.sql.SqlNode SQL} tree to a
 * {@link net.sf.saffron.rel.SaffronRel rel}/{@link RexNode rex} tree.
 ...
 * {@link net.sf.saffron.rex.RexRangeRef} will disappear.</p>
 *
 * @author jhyde
 * @since Nov 23, 2003
 * @version $Id$
...
public class RexRangeRef extends RexNode {
     ...
     */
    RexRangeRef(SaffronType rangeType, int offset) {
        this.type = rangeType;
        this.offset = offset;
    }
