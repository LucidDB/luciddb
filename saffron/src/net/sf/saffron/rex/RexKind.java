...
public class RexKind extends EnumeratedValues.BasicValue {
    ...
    public static final RexKind NotEquals = new RexKind("NotEquals", NotEqualsORDINAL);

    public static final int GreaterThanORDINAL = 3;
    /** The greater-than operator, "&gt;". */
    public static final RexKind GreaterThan = new RexKind("GreaterThan", GreaterThanORDINAL);

    public static final int GreaterEqualORDINAL = 4;
    /** The greater-than-or-equal operator, "&gt;=". */
    public static final RexKind GreaterThanOrEqual = new RexKind("GreaterThanOrEqual", GreaterEqualORDINAL);

    public static final int LessThanORDINAL = 5;
    /** The less-than operator, "&lt;". */
    public static final RexKind LessThan = new RexKind("LessThan", LessThanORDINAL);

    public static final int LessThanOrEqualORDINAL = 6;
    /** The less-than-or-equal operator, "&lt;=". */
    public static final RexKind LessThanOrEqual = new RexKind("LessThanOrEqual", LessThanOrEqualORDINAL);
    ...
    public static final RexKind Comparison = new RexKind("Comparison", ComparisonORDINAL, new RexKind[] {
    ...
    public static final RexKind Logical = new RexKind("Logical", LogicalORDINAL, new RexKind[] {And,Or,Not});
     ...
     * @see #Minus */
    public static final RexKind MinusPrefix = new RexKind("MinusPrefix", MinusPrefixORDINAL);
    ...
    public static final RexKind Arithmetic = new RexKind("Arithmetic", ArithmeticORDINAL, new RexKind[] {
        Divide,Minus,MinusPrefix,Plus,Times});

    public static final int FieldAccessORDINAL = 30;
    /** The arithmetic multiplication operator, "*". */
    public static final RexKind FieldAccess = new RexKind("FieldAccess", FieldAccessORDINAL);
    ...
    /** An identifier. */
    public static final RexKind Identifier = new RexKind("Identifier",IdentifierORDINAL);
    public static final int LiteralORDINAL = 36;
    /** A literal. */
    public static final RexKind Literal = new RexKind("Literal",LiteralORDINAL);
    ...
    public static final RexKind IsFalse = new RexKind("IsFalse", IsFalseORDINAL);
