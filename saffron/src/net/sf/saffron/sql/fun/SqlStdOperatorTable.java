...
/**
 * Extension to {@link net.sf.saffron.sql.SqlOperatorTable} containing the
    ...
    public final SqlInternalOperator litChainOperator =
                               ...
                               useFirstArgType, useFirstKnownParam, null)
        {
                                          ...
                                          SqlValidator.Scope scope)
            {
                ...
                SaffronType firstType = validator.deriveType(scope, operand);
                for (int i = 1; i < call.operands.length; i++) {
                    operand = call.operands[i];
                    SaffronType otherType = validator.deriveType(scope, operand);
            ...
            protected SaffronType inferType(SqlValidator validator,
                ...
                SaffronType rt = validator.getValidatedNodeType(call.operands[0]);
