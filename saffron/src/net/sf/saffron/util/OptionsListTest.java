 ...
 * @version $Id$
*/
public class OptionsListTest extends TestCase {
    private static final String NL = System.getProperty("line.separator");

    public void _testBooleanArg() {
        checkIt("flag=true",
                new OptionsList.Option[] {new OptionsList.BooleanOption("flag", null, "xxx", false, false, false, null)},
                new String[] {"-flag"});
    }
    ...
    public void _testStringArgSameAsDefault() {
        checkIt("foo=default",
                new OptionsList.Option[] {new OptionsList.StringOption("foo", "foo", "xxx", false, false, "default", null)},
                new String[] {"foo=default"});
    }
    public void _testStringArgUsesDefaultValue() {
        checkIt("foo=default (default)",
                new OptionsList.Option[] {new OptionsList.StringOption("foo", "foo", "xxx", false, false, "default", null)},
                new String[] {""});
    }
    public void _testEnumeratedArgShort() {
        checkIt("color=GREEN",
                new OptionsList.Option[] {new OptionsList.EnumeratedOption("c", "color", "", false, false, Color.RED, Color.RED.getEnumeratedType(), null)},
                new String[] {"-c GREEN"});
    }
    ...
    public void _testEnumeratedArgWrong() {
        checkIt("PURPLE is not a valid value",
                new OptionsList.Option[] {new OptionsList.EnumeratedOption("c", "color", "", false, false, Color.RED, Color.RED.getEnumeratedType(), null)},
                new String[] {"-c PURPLE"});
    }
    public void _testEnumeratedArgDefault() {
        checkIt("color=RED (default)", new OptionsList.Option[] {
            new OptionsList.EnumeratedOption("c", "color", "", false, false, Color.RED, Color.RED.getEnumeratedType(), null),
            new OptionsList.NumberOption("x", "x", "", false, false, null, null)},
                new String[] {"-c PURPLE"});
    }
    public void _testMissingMandatory() {
        checkIt("missing x", new OptionsList.Option[] {
            new OptionsList.NumberOption("x", "x", "", true, false, null, null)},
            new String[] {});
    }
    public void _testGroupOptionsMustBeOptional() {
        final OptionsList.NumberOption optionX = new OptionsList.NumberOption("x", "x", "", false, false, null, null);
        final OptionsList.NumberOption optionY = new OptionsList.NumberOption("y", "y", "", true, false, null, null);
        ...
        try {
            ...
            assertContains("fewer than 1...", e.toString());
        }
    }
    public void _testGroupMissing() {
        final StringBufferOptionsHandler handler = new StringBufferOptionsHandler();
        final OptionsList.NumberOption optionX = new OptionsList.NumberOption("x", "x", "", false, false, null, null);
        final OptionsList.NumberOption optionY = new OptionsList.NumberOption("y", "y", "", false, false, null, null);
        final OptionsList.NumberOption optionZ = new OptionsList.NumberOption("z", "z", "", false, false, null, null);
        OptionsList optionsList = new OptionsList(
                new OptionsList.Option[] {optionX, optionY, optionZ});
        optionsList.constrain(new OptionsList.Option[] {optionX, optionY}, 0, 1);
        String[] args = {"-z"};
        optionsList.parse(args);
        assertEquals("foo", handler.toString());
    }
    public void _testAnonymousOption() {
        checkIt("verbose=true" + NL +
                "file=file.txt", new OptionsList.Option[] {
                    new OptionsList.BooleanOption("flag", "flag", "", false, false, false, null),
                    new OptionsList.StringOption("file", "file", "", false, true, "foo.txt", null)
                },
    ...
    public void _testRepeatingOption() {
        checkIt("verbose=true" + NL +
                "file=foo.txt" + NL +
                "file=bar.txt", new OptionsList.Option[] {
                    new OptionsList.BooleanOption("flag", "flag", "", false, false, false, null),
                    new OptionsList.StringOption("file", "file", "", false, true, "foo.txt", null)
                },
    ...
    private void checkIt(final String expected,
            final OptionsList.Option[] options, final String[] args) {
    ...
    /**
     * Implementation of {@link OptionsList.OptionHandler} which
     * writes to a buffer. For testing purposes.
     */
