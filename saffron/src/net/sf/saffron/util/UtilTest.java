...
// (C) Copyright 2004-2004 Disruptive Tec
...
public class UtilTest extends TestCase
{
    ...
    public void testBitString() {
        ...
        assertEquals("0", b0_1.toHexString());
        assertEquals("000", b0_12.toHexString());
        // to byte array
    ...
    private void assertByteArray(String expected, String bits,
            int bitCount) {
