 ...
 * @version $Id$
 **/
public class CollectionToExistsConvertlet extends JavaConvertlet
{
    public CollectionToExistsConvertlet()
    {
        super(CallingConvention.COLLECTION, CallingConvention.EXISTS);
    }
...
// End CollectionToExistsConvertlet.java
