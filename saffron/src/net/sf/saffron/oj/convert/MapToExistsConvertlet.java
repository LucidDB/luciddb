 ...
 * @version $Id$
 **/
public class MapToExistsConvertlet extends JavaConvertlet
{
    public MapToExistsConvertlet()
    {
        super(CallingConvention.MAP, CallingConvention.EXISTS);
    }
...
// End MapToExistsConvertlet.java
