 ...
 * @version $Id$
 **/
public class VectorToIteratorConvertlet extends JavaConvertlet
{
    public VectorToIteratorConvertlet()
    {
        super(CallingConvention.VECTOR, CallingConvention.ITERATOR);
    }
...
// End VectorToIteratorConvertlet.java
