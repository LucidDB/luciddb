 ...
 * @version $Id$
 **/
public class VectorToIterableConvertlet extends JavaConvertlet
{
    public VectorToIterableConvertlet()
    {
        super(CallingConvention.VECTOR, CallingConvention.ITERABLE);
    }
...
// End VectorToIterableConvertlet.java
