 ...
 * and {@link CallingConvention#ENUMERATION} calling-conventions.
 *
 * @author jhyde
 * @since May 27, 2004
 * @version $Id$
 **/
public class VectorToEnumerationConvertlet extends JavaConvertlet {
    public VectorToEnumerationConvertlet() {
        super(CallingConvention.VECTOR,CallingConvention.ENUMERATION);
    }
...
// End VectorToEnumerationConvertlet.java
