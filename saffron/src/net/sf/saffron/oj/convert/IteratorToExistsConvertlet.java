 ...
 * @version $Id$
 **/
public class IteratorToExistsConvertlet extends JavaConvertlet
{
    public IteratorToExistsConvertlet()
    {
        super(CallingConvention.ITERATOR, CallingConvention.EXISTS);
    }
...
// End IteratorToExistsConvertlet.java
