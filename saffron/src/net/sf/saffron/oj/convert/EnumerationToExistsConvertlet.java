 ...
 * @version $Id$
 **/
public class EnumerationToExistsConvertlet extends JavaConvertlet
{
    public EnumerationToExistsConvertlet()
    {
        super(CallingConvention.ENUMERATION, CallingConvention.EXISTS);
    }
...
// End EnumerationToExistsConvertlet.java
