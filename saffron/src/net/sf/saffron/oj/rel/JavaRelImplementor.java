...
public class JavaRelImplementor implements RelImplementor
{
    ...
    /**
     * Maps a {@link SaffronRel} to the unique frame whose {@link Frame#rel}
    ...
    public final Expression visitJavaChild(
        SaffronRel parent, int ordinal, JavaRel child)
    {
        return (Expression) visitChild(parent, ordinal, child);
    }

    public final Object visitChild(SaffronRel parent, int ordinal,
            SaffronRel child) {
        if (parent != null) {
     ...
     * {@link net.sf.saffron.oj.rel.JavaRel#implement} on the root element.
     */
     ...
     * <code>JavaRelImplementor</code>).  Compare this method with {@link
        ...
        int fieldOrdinal)
    {
        ...
        final RexNode expr = _rexBuilder.makeInputRef(fields[fieldIndex].getType(), fieldIndex);
    ...
    /**
     * Similar to {@link net.sf.saffron.oj.rel.RexToJavaTranslator}, but instead of translating, merely tests
    ...
    public static class TranslationTester {
        ...
        /**
         * Walks over an expression, and throws {@link net.sf.saffron.oj.rel.JavaRelImplementor.TranslationTester.CannotTranslate} if
         * expression cannot be translated.
         *
         * @param rex Expression
         * @throws net.sf.saffron.oj.rel.JavaRelImplementor.TranslationTester.CannotTranslate if expression or a sub-expression cannot be
         *   translated
         */
