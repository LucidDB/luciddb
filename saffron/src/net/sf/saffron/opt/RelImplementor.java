 ...
 * {@link SaffronRel relational expressions} into a plan. Calling conventions
...
public interface RelImplementor
{
     ...
     */
    Object visitChild(SaffronRel parent, int ordinal, SaffronRel child);
     ...
     * @return
     */
    Object visitChildInternal(SaffronRel child);
}
