...
public class CallingConvention extends EnumeratedValues.BasicValue
{
    ...
    public static final CallingConvention NONE = new CallingConvention(
            "NONE",NONE_ORDINAL, SaffronRel.class);
     ...
     *
     * <p>
     * The {@link net.sf.saffron.oj.rel.JavaRel#implement} method generates a
     ...
     * {@link net.sf.saffron.oj.rel.JavaRelImplementor#getStatementList}).
     * </li>
     * </ul>
     * </p>
     */
     ...
     * must implement. Must be a sub-interface of {@link SaffronRel}.
     */
    ...
    public CallingConvention(String name,int ordinal, Class interfaze)
    {
        ...
        Util.pre(SaffronRel.class.isAssignableFrom(interfaze),
                "SaffronRel.class.isAssignableFrom(interfaze)");
    }
}
