...
class RuleQueue
{
    ...
    SaffronRel pop()
    {
        while (true) {
            ...
            final SaffronRel cheapestMember = findCheapestMember(subset);
    ...
    /**
     * Compares {@link SaffronRel} objects according to their cached
     * 'importance'.
     */
