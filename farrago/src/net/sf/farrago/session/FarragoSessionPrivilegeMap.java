...
/**
 * FarragoSessionPrivilegeMap defines a map from object type to
 * a set of privileges relevant to that type.  Map instances may
 * be immutable, in which case only read accessors may be called.
 *
 * @author John V. Sichi
 * @version $Id$
 */
public interface FarragoSessionPrivilegeMap
{
     ...
     * (e.g. RelationalPackage.getCwmTable())
     *
     ...
     * exception
     *
     * @param includeSubclasses if true, set privilege for refClass and
     * all of its subclasses; if false, set privilege for refClass only
     */
