...
/**
 * MedPropertyInfoList is a helper class for building up the arrays of
 * DriverPropertyInfo returned by various getXXXPropertyInfo calls.
 *
 * @author John V. Sichi
 * @version $Id$
 */
public class MedPropertyInfoList
{
     ...
     */
    public MedPropertyInfoList(Properties defaultProps)
    {
    ...
    public DriverPropertyInfo [] toArray()
    {
        return (DriverPropertyInfo [])
            propertyInfoList.toArray(MedAbstractBase.EMPTY_DRIVER_PROPERTIES);
    }
}

// End MedPropertyInfoList.java
