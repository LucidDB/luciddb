...
public abstract class FennelAttributeAccessor
{
    ...
    /**
     * Unmarshalls the attribute's value into a tupledatum holder. Unlike
     * the C++ version, this *does* actually copy data.
     * 
     * @param tupleAccessor containing FennelTupleAccessor set up
    ...
    /**
     * Marshalls value data for the attribute.  Only deals with the
        ...
        extends FennelAttributeAccessor
    {
        ...
        {
            /*
            System.out.println("FixedAccessor - marshalling - offset " + fixedOffset + 
                               ", len " + capacity);
            */
            pDestData.position(fixedOffset);
            pDestData.put(value.getBytes(), 0, value.getLength());
        }
        ...
        extends FennelAttributeAccessor
    {
        ...
        {
            /*
            System.out.println("FennelByteAccessor - marshalling - offset " + fixedOffset +
                               ", len " + capacity + " at position " + pDestData.position());
            */
            pDestData.position(fixedOffset);
        ...
        {
            /*
            System.out.println("FennelByteAccessor - unmarshalling - offset " + fixedOffset +
                               ", len " + capacity);
            */
            tupleAccessor.getCurrentTupleBuf().position(fixedOffset);
        ...
        extends FennelAttributeAccessor
    {
        ...
        {
            /*
            System.out.println("FennelShortAccessor - marshalling - offset " + fixedOffset +
                               ", len " + capacity + " at position " + pDestData.position());
            */
            pDestData.putShort(fixedOffset, value.getShort());
        }
        ...
        {
            /*
            System.out.println("FennelShortAccessor - unmarshalling - offset " + fixedOffset +
                               ", len " + capacity);
            */
            value.setShort(
     ...
     */
    public static class FennelIntAccessor extends FennelAttributeAccessor
    {
        public void marshalValueData(
            ByteBuffer pDestData,
            FennelTupleDatum value)
        ...
        {
            /*
            System.out.println("FennelIntAccessor - marshalling - offset " + fixedOffset +
                               ", len " + capacity + " at position " + pDestData.position());
            */
            pDestData.putInt(fixedOffset, value.getInt());
        }
        ...
        {
            /*
            System.out.println("FennelIntAccessor - unmarshalling - offset " + fixedOffset +
                               ", len " + capacity);
            */
            value.setInt(
        ...
        extends FennelAttributeAccessor
    {
        ...
        {
            /*
            System.out.println("FennelLongAccessor - marshalling - offset " + fixedOffset +
                               ", len " + capacity + " at position " + pDestData.position());
            */
            pDestData.putLong(fixedOffset, value.getLong());
        }
        ...
        {
            /*
            System.out.println("FennelLongAccessor - unmarshalling - offset " + fixedOffset +
                               ", len " + capacity);
            */
            value.setLong(
     ...
     */
    public static final class FennelBitAccessor extends FennelAttributeAccessor
    {
        public void marshalValueData(
            ByteBuffer pDestData,
            FennelTupleDatum value)
        ...
        {
            /*
            System.out.println("FennelBitAccessor - marshalling - bitoffset " + valueBitOffset +
                               ", mask " + valueBitMask);
            */
        ...
        {
            /*
            System.out.println("FennelBitAccessor - unmarshalling - bitoffset " + valueBitOffset +
                               ", mask " + valueBitMask);
            */
     ...
     * <p> 
     *
     * The first variable width accessor has special handling; it
     * is indicated by having its fixedOffset set to a value other
     * than the default (Integer.MAX_VALUE)
     */
        ...
        extends FennelAttributeAccessor
    {
        ...
        {
            /*
            System.out.println("FennelVarWidthAccessor - marshalling " + value.getLength() +
                                " bytes into buffer at position " + pDestData.position() +
                                ", fixedOffset is " + fixedOffset);
            */
            ...
            FennelTupleDatum value)
        {
            ...
            if (fixedOffset != Integer.MAX_VALUE) {
                ...
                offset = fixedOffset; 
                endOffset = FennelTupleAccessor.readUnsignedShort(
                    srcBuf,
                    endIndirectOffset);
            } else {
                offset    = FennelTupleAccessor.readUnsignedShort(
                    srcBuf, 
                    endIndirectOffset-2);
                endOffset = FennelTupleAccessor.readUnsignedShort(
                    srcBuf,
            ...
            System.out.println("FennelVarWidthAccessor - unmarshalling " +
                                value.getLength() + " bytes from offset " +
                                offset + ", length " + value.getLength());
            */
            srcBuf.position(offset);
            srcBuf.get(value.setRawBytes(), 0, value.getLength());
        }
    };
};
