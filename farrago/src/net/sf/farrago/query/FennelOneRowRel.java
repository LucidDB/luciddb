...
/**
 * FennelOneRowRel is a Fennel implementation of {@link OneRowRel}.
 *
 * @author Wael Chatila
 * @since Feb 4, 2005
 * @version $Id$
 */
public class FennelOneRowRel extends AbstractRelNode implements FennelRel
{
    public FennelOneRowRel(RelOptCluster cluster)
    {
    ...
    public Object clone()
    {
        FennelOneRowRel clone = new FennelOneRowRel(getCluster());
