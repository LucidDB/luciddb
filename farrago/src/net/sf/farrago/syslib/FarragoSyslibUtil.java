...
/**
 * FarragoSyslibUtil provides utility methods useful when constructing
 * UDR's.
 *
 * @author John Sichi
 * @version $Id$
...
public abstract class FarragoSyslibUtil
{
     ...
     *</ul>
     *
     * NOTE jvs 19-Apr-2008:  once we support character set collations,
     ...
     *
     * @return negative for obj1 < obj2; positive for obj1 > obj2;
     * zero for obj1 == obj2
     */
