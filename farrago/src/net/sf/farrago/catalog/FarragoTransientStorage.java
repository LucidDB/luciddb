...
{
    // NOTE jvs 6-May-2004:  I had extend StorageImpl to avoid having to
    ...
    public synchronized void create(
        boolean replace, ObjectResolver resolver) throws StorageException
    {
        createPrimaryIndex();
    }
        ...
        throws StorageException
    {
        ...
        SinglevaluedIndex sm = new SVIndex(
            name, this, keyType, valueType);
        addIndex(name, sm);
        return sm;
    }
    ...
    public synchronized MultivaluedOrderedIndex createMultivaluedOrderedIndex(
        ...
        throws StorageException
    {
        MultivaluedOrderedIndex sm = new MVIndex(
            name, this, keyType, valueType, unique);
        addIndex(name, sm);
        return sm;
    }
    ...
    public synchronized MultivaluedIndex createMultivaluedIndex(
        ...
        throws StorageException
    {
        MultivaluedIndex sm = new MVIndex(
            name, this, keyType, valueType, unique);
        addIndex(name, sm);
        return sm;
    }
    ...
    {
        public void commitChangesPublic() throws StorageException;

        public void rollBackChangesPublic() throws StorageException;
    }
        ...
        implements TxnIndex
    {
        public MVIndex(
            ...
            StorageImpl storage,
            Storage.EntryType keyType,
            Storage.EntryType valueType, boolean unique)
        {
