...
public class ProxyGen
{
    ...
    public void generateClassDefinitions(PrintWriter pw)
    {
        ...
        pw.println("class " + visitorClassName + " : public "
                   + visitorBaseName);
        pw.println("{");
        pw.println("public:");
    ...
    public void generateClassImplementations(PrintWriter pw)
    {
        ...
        while (iter.hasNext()) {
            ...
            for (int i = 0; i < methods.length; ++i) {
                if (isGetter(methods[i])) {
                    generateMethodDefinition(methods[i]);
                    pw.println();
                }
            }
        }
     ...
     *
     * <li>args[2] = qualified name of source model package
     *
     * <li>args[3] = prefix to use for generated objects
     *
     * <li>args[4] = (optional) qualified name of model package
     * to reference as base; if this is not specified, generated
     * objects are base classes
     *
     * <li>args[5] = (optional) prefix to reference for base classes;
        ...
        throws ClassNotFoundException,IOException
    {
        ...
        String sourcePackageName = args[2];
        String genPrefix = args[3];
        
        String basePackageName = null;
        String basePrefix = null;
        if (args.length > 4) {
            assert(args.length == 6);
            basePackageName = args[4];
            basePrefix = args[5];
        }
