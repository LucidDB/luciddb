...
/**
 * Wrapper around the sqlline code to enable running of a SQL script from
 * within Java code.
 * 
 * @author chard
 * @since Jun 30, 2006
...
public class SqlRunner
{
    ...
    protected static Logger logger = Logger.getLogger(SqlRunner.class.getName());
     ...
     * All outputs to stdout and stderr are unchanged.
     ...
     * @throws SQLException
     */
    public void runScript(String pathName, String url, String userName,
        String password)
    throws SQLException
    {
     ...
     */
    public void runScript(String pathName, String url, String userName,
        String password, PrintStream out)
    throws SQLException
    {
    ...
    /**
     * Run the specified SQL script against the server at the specified URL.
     * The caller can redirect stdout and/or stderr to alternate streams, if
     * desired.
     * @param pathName String containing a path name to a SQL script
     * @param url String specifying the URL of a server
     * @param userName String specifying the user to log into the server as
     ...
     * @throws SQLException All errors in execution are converted into
     * @link SQLException} and thrown. Null values for either
     * <code>pathName</code> or <code>url</code> will assert.
     */
    public void runScript(String pathName, String url, String userName,
        String password, PrintStream out, PrintStream err)
    throws SQLException
    {
        ...
        try {
            ...
            logger.throwing(this.getClass().getName(), "runScript()", se);
            throw se;
        }
        finally {
            if (out != null) {
