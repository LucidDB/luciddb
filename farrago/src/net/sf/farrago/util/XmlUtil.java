...
public abstract class XmlUtil
{
    ...
    /**
     * Get the value of an int attribute from an XML element.
     *
    ...
    /**
     * Append an empty tag as a child of an existing element.
     *
    ...
    /**
     * Create a new DOM document with an empty top-level tag.
     *
    ...
    /**
     * Parse an XML string into DOM.  Parse failures result in an internal
