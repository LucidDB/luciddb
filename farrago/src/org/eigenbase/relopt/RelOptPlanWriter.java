...
public class RelOptPlanWriter extends java.io.PrintWriter
{
    ...
    public RelOptPlanWriter(java.io.PrintWriter pw,boolean brief)
    {
        super(pw);
        this.level = 0;
        this.brief = brief;
    ...
    public void explain(RelNode rel,String [] terms,Object [] values)
    {
        ...
        s = s + rel.getRelTypeName() +
                ((AbstractRelNode) rel).getQualifier();
        if (brief) {
    ...
    public void explain(RelNode rel,String [] terms)
    {
     ...
     */
    public void explainSubset(String s,RelNode child)
    {
        print(s);
        level++;
        child.explain(this);
    ...
    private void explainBrief(String s,RelNode rel,String [] terms)
    {
        print(s);
        if (active.add(rel)) {
            RelNode [] inputs = rel.getInputs();
