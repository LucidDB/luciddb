...
/**
 * RelTraitDef represents a class of {@link RelTrait}s.  Implementations
 * of RelTraitDef may be singletons under the following conditions:
 * <ol>
 *   <li>
...
public abstract class RelTraitDef
{
    ...
    public final RelTrait canonize(RelTrait trait)
    {
        assert(getTraitClass().isInstance(trait)):
            getClass().getName() + " cannot canonize a "
        ...
        // canonical.
        canonicalMap.put(trait, new WeakReference(trait));
