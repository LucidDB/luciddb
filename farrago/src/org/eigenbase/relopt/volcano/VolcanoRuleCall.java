    ...
    extends RelOptRuleCall
{
     ...
     */
    List<RelNode> generatedRelList;

    /**
     * Reason why rule call did not produce successors. For debugging purposes.
     */
    ...
    public void transformTo(RelNode rel)
    {
        ...
        try {
            ...
            getPlanner().ensureRegistered(rel, rels[0], this);
        ...
        try {
            ...
            if (tracer.isLoggable(Level.FINE)) {
                ...
                if (generatedRelList.isEmpty()) {
                    if (reason == null) {
                        msg = "Match generated 0 successors. No reason given.";
                    } else {
                        msg = "Match generated 0 successors. Reason: " + reason;
                        reason = null;
                    }
                } else {
                    msg =
