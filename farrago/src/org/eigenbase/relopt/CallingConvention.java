...
/**
 * <code>CallingConvention</code> enumerates the calling conventions built in
 * to the Saffron project.  This set can be extended by applications by
 * defining new instances of CallingConvention and registering them with a
...
public class CallingConvention implements RelTrait
{
     ...
     *
     * <p>
     * The {@link org.eigenbase.oj.rel.JavaRel#implement} method generates a
     ...
     * RelNode#implement}() on the parent.
     * </li>
     * <li>
     * The code is generated into the <dfn>current block</dfn> (gleaned from
     * {@link org.eigenbase.oj.rel.JavaRelImplementor#getStatementList}).
     * </li>
     * </ul>
     * </p>
     */
