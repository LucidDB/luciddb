 ...
 */
public class CompoundTupleIter implements TupleIter
{
    ...
    public static class Test extends EigenbaseTestCase
    {
        ...
        {
            TupleIter iterator =
                new CompoundTupleIter(new TupleIter [] {
        ...
        public void testCompoundCalcIter()
        {
            TupleIter iterator =
                new CompoundTupleIter(new TupleIter [] {
                    makeCalcTupleIter(makeTupleIter(new String [] { "a", "b" })),
        ...
        public void testCompoundCalcIterFirstEmpty()
        {
            TupleIter iterator =
                new CompoundTupleIter(new TupleIter [] {
                    ...
                    makeCalcTupleIter(makeTupleIter(new String [] {  })),
                    makeCalcTupleIter(makeTupleIter(new String [] {  })),
                    makeCalcTupleIter(makeTupleIter(new String [] { "b", "c" })),
                    makeCalcTupleIter(makeTupleIter(new String [] {  }))
                });
            assertEquals(
                iterator,
        ...
        // An TupleIter that always returns the same object, a Box, but with different
        // contents. Mimics the TupleIter from a farrago dynamic statement.
        static class BoxTupleIter implements TupleIter
        {
            TupleIter base;
            Box box;
        ...
        /**
         * Checks that a BoxTupleIter returns the same values as the
        ...
        public void testCompoundBoxIter()
        {
            TupleIter iterator =
                new CompoundTupleIter(new TupleIter[] {
                    new BoxTupleIter(makeTupleIter(new String[] {"400", "401", "402", "403"})),
                    new BoxTupleIter(makeTupleIter(new String[] {"500", "501", "502", "503"})),
                    new BoxTupleIter(makeTupleIter(new String[] {"600", "601", "602", "603"}))
                });
            assertUnboxedEquals(
                iterator,
        ...
        public void testCompoundBoxedCalcIter()
        {
            TupleIter iterator =
                new CompoundTupleIter(new TupleIter[] {
                    new BoxTupleIter(makeCalcTupleIter(makeTupleIter(new String[] {"400", "401", "402", "403"}))),
                    new BoxTupleIter(makeCalcTupleIter(makeTupleIter(new String[] {"500", "501", "502", "503"}))),
                    new BoxTupleIter(makeCalcTupleIter(makeTupleIter(new String[] {"600", "601", "602", "603"})))
                });
            assertUnboxedEquals(
                iterator,
                new String[] {"400", "401", "402", "403",
