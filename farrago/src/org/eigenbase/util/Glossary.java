...
public class Glossary
{
     ...
     * The table uses information from the GoF book and
     * from a course on advanced object design taught by Craig Larman.</p>
     *
     * <p>The patterns are in three groups depicting frequency of use. The *
     * patterns in <b> <font color="lime">light green</font></b> are used
     * <i>frequently</i>. Those in <b><font color="#ffff00">yellow</font></b>
     * have <i>moderate</i> use. Patterns in <b><font
     * color="red">red</font></b> are <i>infrequently</i> used. The GoF column
     * gives the original Gang Of Four category for the pattern. The Problem
     * and Pattern columns are from Craig's refinement of the type of problems
     * they apply to and a refinement of the original three pattern
     * categories.</p>
     *
     * <table cellSpacing="0" cols="6" cellPadding="3" border="1">
     *     <caption align="bottom">
     *     <a href="http://www.onr.com/user/loeffler/java/references.html#gof"><b>Gang
     ...
     *     <tr>
     *       <td bgColor="lime">
     *       <a href="#AbstractFactoryPattern">
     *       Abstract Factory</a> </td>
     ...
     *       <a href="#SingletonPattern">Singleton</a> with <a href="#FacadePattern">Facade</a> </td>
     *       <td><a href="#FactoryMethodPattern">Factory Method</a><br>
     *       <a href="#PrototypePattern">Prototype</a><br>
     ...
     *       <td>Wrap Many</td>
     *       <td><a href="#SingletonPattern">Singleton</a> with <a href="#AbstractFactoryPattern">
     *       Abstract Factory</a> </td>
     ...
     *     <tr>
     *       <td bgColor="lime">
     *       <a href="#TemplateMethodPattern">
     *       Template Method</a> </td>
     *       <td bgColor="maroon"><font color="white">Behavioral</font></td>
     *       <td>Single Algorithm</td>
     ...
     *     <tr>
     *       <td bgColor="yellow">
     *       <a href="#ChainOfResponsibilityPattern">
     *       Chain of Responsibility</a> </td>
     *       <td bgColor="maroon"><font color="white">Behavioral</font></td>
     ...
     *     <tr>
     *       <td bgColor="red">
     *       <a href="#InterpreterPattern">
     *       <font color="white">Interpreter</font></a> </td>
     *       <td bgColor="maroon"><font color="white">Behavioral</font></td>
     ...
     *     <tr>
     *       <td bgColor="red">
     *       <a href="#MementoPattern">
     *       <font color="white">Memento</font></a> </td>
     *       <td bgColor="maroon"><font color="white">Behavioral</font></td>
     ...
     * (See <a href="http://c2.com/cgi/wiki?AbstractFactoryPattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?FactoryMethodPattern">GoF</a>.)
     */
    public static final Glossary FactoryMethodPattern = null;

    /**
     * Specify the kinds of objects to create using a prototypical instance, and create new objects by copying this prototype.
     * (See <a href="http://c2.com/cgi/wiki?PrototypePattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?AdapterPattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?BridgePattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?CompositePattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?DecoratorPattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?MediatorPattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?StatePattern">GoF</a>.)
     */
    public static final Glossary StatePattern = null;

    /**
     * Define a family of algorithms, encapsulate each one, and make them interchangeable. Lets the algorithm vary independently from clients that use it.
     * (See <a href="http://c2.com/cgi/wiki?StrategyPattern">GoF</a>.)
     */
     ...
     * (See <a href="http://c2.com/cgi/wiki?TemplateMethodPattern">GoF</a>.)
     */
    public static final Glossary TemplateMethodPattern = null;

    /**
     * Represent an operation to be performed on the elments of an object structure. Lets you define a new operation without changing the classes of the elements on which it operates.
     * (See <a href="http://c2.com/cgi/wiki?VisitorPattern">GoF</a>.)
     */
    public static final Glossary VisitorPattern = null;

    /**
     * The official SQL-92 standard (ISO/IEC 9075:1992).  To reference
     * this standard from methods that implement its rules, use
     * the &#64;sql.92 custom block tag in Javadoc comments; for
     ...
     *<p>
     *
     * Note that this tag is a block tag (like &#64;see) and cannot be
     * used inline.
     */
     ...
     * this standard from methods that implement its rules, use
     * the &#64;sql.99 custom block tag in Javadoc comments; for
     * the tag body, use the format
     ...
     * this standard from methods that implement its rules, use
     * the &#64;sql.2003 custom block tag in Javadoc comments; for
     * the tag body, use the format
     * <code>&lt;PartId&gt; &lt;SectionId&gt;
     * [ ItemType &lt;ItemId&gt; ]</code>, where
     * 
