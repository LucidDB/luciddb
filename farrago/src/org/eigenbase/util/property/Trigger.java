 ...
 * {@link java.lang.ref.WeakReference}, so
 ...
 * {@link #execute} method that will never be garbage-collected) are
 ...
 *
 * <p>
 * Note that it is up to the creator of a set of triggers to make
...
public interface Trigger
{
     ...
     * @param property
     */
    void execute(Property property, String value) throws VetoRT;
}
