...
public class OptionsListTest extends TestCase
{
    ...
    public void _testBooleanArg()
    {
        checkIt(
            ...
            new OptionsList.Option [] {
                new OptionsList.BooleanOption("flag", null, "xxx", false,
                    false, false, null)
            },
            new String [] { "-flag" });
    }
    ...
    public void _testStringArgSameAsDefault()
    {
        checkIt(
            "foo=default",
            new OptionsList.Option [] {
                new OptionsList.StringOption("foo", "foo", "xxx", false,
                    false, "default", null)
            },
        ...
        checkIt(
            ...
            new OptionsList.Option [] {
                new OptionsList.EnumeratedOption(
                    ...
                    Color.RED.getEnumeratedType(),
                    null),
                new OptionsList.NumberOption("x", "x", "", false, false, null,
                    null)
            },
            new String [] { "-c PURPLE" });
    }
    ...
    public void _testMissingMandatory()
    {
        checkIt(
            "missing x",
            new OptionsList.Option [] {
                new OptionsList.NumberOption("x", "x", "", true, false, null,
                    null)
            },
            new String [] {  });
    }
    ...
    public void _testGroupMissing()
    {
        ...
        final OptionsList.NumberOption optionX =
            new OptionsList.NumberOption("x", "x", "", false, false, null, null);
        final OptionsList.NumberOption optionY =
            new OptionsList.NumberOption("y", "y", "", false, false, null, null);
        final OptionsList.NumberOption optionZ =
            new OptionsList.NumberOption("z", "z", "", false, false, null, null);
        OptionsList optionsList =
            new OptionsList(new OptionsList.Option [] { optionX, optionY, optionZ });
        optionsList.constrain(
            new OptionsList.Option [] { optionX, optionY },
            0,
            1);
    ...
    public void _testAnonymousOption()
    {
        checkIt(
            ...
            new OptionsList.Option [] {
                new OptionsList.BooleanOption("flag", "flag", "", false,
                    false, false, null),
                new OptionsList.StringOption("file", "file", "", false, true,
                    "foo.txt", null)
            },
