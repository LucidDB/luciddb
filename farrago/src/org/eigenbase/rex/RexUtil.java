...
public class RexUtil
{
    ...
    /**
     * Applies a mapping to an array of field collations.
     *
     * @param mapping Mapping
    ...
    {
        final RelFieldCollation[] newFieldCollations = fieldCollations.clone();
        for (int i = 0; i < newFieldCollations.length; i++) {
            newFieldCollations[i] = apply(mapping, newFieldCollations[i]);
        }
