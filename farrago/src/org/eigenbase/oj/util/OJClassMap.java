...
public class OJClassMap
{
    ...
    /**
     * Creates a <code>OJSyntheticClass</code> with named fields.  We don't
     * check whether there is an equivalent class -- all classes with named
        ...
        boolean isJoin)
    {
        ...
        assert classes.length == fieldNames.length :
            "OJSyntheticClass.create: mismatch between classes and field names";
        ...
        OJSyntheticClass clazz = (OJSyntheticClass)
