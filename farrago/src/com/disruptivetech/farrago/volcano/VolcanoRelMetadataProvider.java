 ...
 * interface by combining metadata from the rels making
...
public class VolcanoRelMetadataProvider implements RelMetadataProvider
{
        ...
        Object [] args)
    {
        ...
        // should be here.  Letting the current best plan take the first shot
        // is probably the right thing to do for physical estimates such as row
        ...
        // Otherwise, try rels in same logical equivalence class to
        // see if any of them have a good answer.  We use the full logical
        // equivalence class rather than just the subset because
        ...
        // PercentageOriginalRows -> Selectivity.  If we implement
        // caching at this level, we could probably kill two birds
        // with one stone (use presence of pending cache entry to
        // detect reentrancy at the correct granularity).
