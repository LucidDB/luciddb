    ...
    RegisterReference* targetDataType)
{
    ...
    if (StandardTypeDescriptor::isExact(dType)) {
        histogramObject =
            reinterpret_cast<PBuffer>(new WinAggHistogram<int64_t>);
    } else if (StandardTypeDescriptor::isApprox(dType)) {
        histogramObject =
            reinterpret_cast<PBuffer>(new WinAggHistogram<double>);
    } else if (StandardTypeDescriptor::isArray(dType)) {
        histogramObject =
            reinterpret_cast<PBuffer>(new WinAggHistogramStrA);
    } else {
...
inline void add(RegisterRef<STDTYPE>* node, RegisterRef<char*>* aggDataBlock)
{
    ...
    WinAggHistogram<STDTYPE> *pAcc =
        *(reinterpret_cast<WinAggHistogram<STDTYPE>**>(
...
//! COUNT - Template function that returns the current COUNT value for
//! the window specified data type.
//!
//! INPUT:
//! result - Register returns the MIN value
//! aggDataBlock - Aggregation accumulator
...
ExtWinAggFuncRegister(ExtendedInstructionTable* eit)
{
    ...
    eit->add(
        "WinAggSum", params_I64_funcs,
        (ExtendedInstruction2<int64_t, char*>*) NULL,
        &WinAggSum);

    eit->add(
        "WinAggCount", params_I64_funcs,
        (ExtendedInstruction2<int64_t, char*>*) NULL,
        &WinAggCount);

    eit->add(
        "WinAggAvg", params_I64_funcs,
        (ExtendedInstruction2<int64_t, char*>*) NULL,
        &WinAggAvg);

    eit->add(
        "WinAggMin", params_I64_funcs,
        (ExtendedInstruction2<int64_t, char*>*) NULL,
        &WinAggMin);

    eit->add(
        "WinAggMax", params_I64_funcs,
        (ExtendedInstruction2<int64_t, char*>*) NULL,
        &WinAggMax);

    eit->add(
        "WinAggFirstValue", params_I64_funcs,
        (ExtendedInstruction2<int64_t, char*>*) NULL,
        &WinAggFirstValue);

    eit->add(
        "WinAggLastValue", params_I64_funcs,
        (ExtendedInstruction2<int64_t, char*>*) NULL,
        &WinAggLastValue);
    ...
    eit->add(
        "WinAggMax", params_DBL_funcs,
        (ExtendedInstruction2<double, char*>*) NULL,
        &WinAggMax);

    eit->add(
        "WinAggSum", params_DBL_funcs,
        (ExtendedInstruction2<double, char*>*) NULL,
        &WinAggSum);

    eit->add(
        "WinAggAvg", params_DBL_funcs,
        (ExtendedInstruction2<double, char*>*) NULL,
        &WinAggAvg);

    eit->add(
        "WinAggFirstValue", params_DBL_funcs,
        (ExtendedInstruction2<double, char*>*) NULL,
        &WinAggFirstValue);

    eit->add(
        "WinAggLastValue", params_DBL_funcs,
        (ExtendedInstruction2<double, char*>*) NULL,
        &WinAggLastValue);
    ...
    eit->add(
        "WinAggMax", params_StrA_funcs,
        (ExtendedInstruction2<char*, char*>*) NULL,
        &WinAggMax);

    eit->add(
        "WinAggFirstValue", params_StrA_funcs,
        (ExtendedInstruction2<char*, char*>*) NULL,
        &WinAggFirstValue);

    eit->add(
        "WinAggLastValue", params_StrA_funcs,
        (ExtendedInstruction2<char*, char*>*) NULL,
        &WinAggLastValue);
    ...
    eit->add(
        "WinAggMax", params_StrA2_funcs,
        (ExtendedInstruction2<char*, char*>*) NULL,
        &WinAggMax);

    eit->add(
        "WinAggFirstValue", params_StrA2_funcs,
        (ExtendedInstruction2<char*, char*>*) NULL,
        &WinAggFirstValue);

    eit->add(
        "WinAggLastValue", params_StrA2_funcs,
        (ExtendedInstruction2<char*, char*>*) NULL,
        &WinAggLastValue);
}
