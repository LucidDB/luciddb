...
ExtDynamicVariableRegister(ExtendedInstructionTable* eit)
{
    ...
    eit->add(
        "dynamicVariable", params_varchar,
        (ExtendedInstruction2<char*, int32_t>*) NULL,
        &dynamicVariable);
    ...
    eit->add(
        "dynamicVariable", params_varbinary,
        (ExtendedInstruction2<char*, int32_t>*) NULL,
        &dynamicVariable);
