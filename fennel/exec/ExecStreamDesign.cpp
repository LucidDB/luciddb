...
<li><em>upstream</em>:  reachable by traversing dataflow edges in the
opposite direction of the arrows.

<li><em>downstream</em>:  reachable by traversing dataflow edges in the
direction of the arrows.

<li><em>producer</em>:  in a dataflow edge, the stream which produces the
...
<li><em>consumer</em>:  in a dataflow edge, the stream which consumes the
...
<li><em>source</em>:  a vertex which is not a consumer.  In the example
...
<li><em>sink</em>:  a vertex which is not a producer.  In the example
...
<li><em>input</em>: a dataflow edge as seen by its consumer.  Somtimes
...
<li><em>output</em>: a dataflow edge as seen by its producer.  Sometimes
