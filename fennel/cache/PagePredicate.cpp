...
DeviceIdPagePredicate::DeviceIdPagePredicate(DeviceId deviceIdinit)
{
...
MappedPageListenerPredicate::MappedPageListenerPredicate(
    MappedPageListener &listenerInit)
    : listener(listenerInit)
{
}

bool MappedPageListenerPredicate::operator()(CachePage const &page)
{
