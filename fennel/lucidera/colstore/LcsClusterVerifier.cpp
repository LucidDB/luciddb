...
LcsClusterVerifier::LcsClusterVerifier(BTreeDescriptor &treeDescriptor) :
...
{
    pageData.bTreeRid = bTreeRid;
    pageData.clusterPageId = clusterPageId;
    return pageData;
}

FENNEL_END_CPPFILE("$Id$");

// End LcsClusterVerifier.cpp
